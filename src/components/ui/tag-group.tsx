...
const badgeVariants = cva(
  [
    ...
    /* Focus */
    "data-[focused]:outline-none data-[focused]:ring-2 data-[focused]:ring-[#7B5CF0] data-[focused]:ring-offset-2",
    /* Disabled */
  ...
  ],
  {
    variants: {
      variant: {
        default: [
          "border-transparent bg-[#7B5CF0] text-white",
          /* Hover */
          "data-[hovered]:bg-[#6442DF]",
        ],
        secondary: [
          "border-transparent bg-[#111111] text-[#999999]",
          /* Hover */
          "data-[hovered]:bg-[#222222] data-[hovered]:text-white",
        ],
        destructive: [
